          ...
          <div class="modal-header-orden">
            <div class="modal-header-grid-orden">
              ...
              <div class="header-center">
                <h4 class="modal-title">Nueva Orden de Venta</h4>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", () => {
        ...
        async function listarPendientes() {
          try {
            const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/listar_ventas.php");
        ...
        formComprobante.addEventListener("submit", async (e) => {
          ...
          try {
            ...
            const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/upload_comprobante.php", {
              method: "POST",
              body: formData
            });
    ...
    <script>
      document.addEventListener("DOMContentLoaded", () => {
        ...
        document.body.addEventListener("click",async(e) => {
          ...
          tituloModal.textContent = "Actualizar Orden de Venta";
          ...
          try {
            const res = await fetch("<?php echo URL_BACKEND; ?>" +`/allura/allura-backend/api/ventas/listar_items.php?order_id=${fila.dataset.orderId}`);
            const result = await res.json();
        ...
        formOrden.addEventListener("submit", async (e) => {
          ...
          if (!btnGuardar.dataset.mode || btnGuardar.dataset.mode === "create") {
            ...
            try {
              ...
              const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/guardar_orden.php", {
                method: "POST",
              ...
              // Generar PDF
              const pdfRes = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/generar_pdf.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
          ...
          if (btnGuardar.dataset.mode === "edit"){
            ...
            try {
              ...
              const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/actualizar_orden.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
              ...
              const pdfUpdate = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/actualizar_pdf.php", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
              ...
              const tituloModal = modalCrear.querySelector(".modal-title");
              if (tituloModal) tituloModal.textContent = "Nueva Orden de Venta";
        ...
        modalCrear.addEventListener("hidden.bs.modal", () => {
          ...
          const eliminarBtn = formOrden.querySelector(".btnEliminarOrden");
          if (eliminarBtn) eliminarBtn.remove();
          tituloModal.textContent = "Nueva Orden de Venta";
      ...
      document.addEventListener("DOMContentLoaded", () => {
        document.body.addEventListener("click", async (e) => {
          ...
          try {
            ...
            const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/ventas/eliminar_orden.php", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
      ...
      document.addEventListener('DOMContentLoaded', async () => {
        ...
        async function obtenerSuplidores() {
          try {
            ...
            const res = await fetch("<?php echo URL_BACKEND; ?>" +"/allura/allura-backend/api/clients/list.php");
            const data = await res.json();
