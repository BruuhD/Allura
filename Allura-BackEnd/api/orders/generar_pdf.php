...
// =============================
// 2. Ruta donde se guardará el PDF
// =============================
...
$fileName = 'orden_compra_' . str_pad($order_number, 6, "0", STR_PAD_LEFT) . '.pdf';
...
$pdf->Cell(0, 10, utf8_decode("ORDEN DE COMPRA"), 0, 1, "C");
$pdf->Ln(3);

$pdf->SetFont("Arial", "", 12);
$pdf->Cell(0, 8, utf8_decode("No. de Orden: ") . str_pad($order_number, 6, "0", STR_PAD_LEFT), 0, 1, "R");
$pdf->Cell(0, 8, utf8_decode("Código NFC: " . ($nfc_code ?: "N/A")), 0, 1, "R");

$pdf->Ln(8);

$pdf->SetFont("Arial", "B", 12);
$pdf->Cell(0, 8, utf8_decode("Datos del Suplidor"), 0, 1);
$pdf->SetFont("Arial", "", 11);
$pdf->Cell(100, 6, utf8_decode("Proveedor: ") . $proveedor, 0, 0);
$pdf->Cell(0, 6, utf8_decode("RNC / Cédula: ") . $rnc, 0, 1);
$pdf->Cell(100, 6, utf8_decode("Teléfono: ") . $telefono, 0, 0);
...
$pdf->SetFont("Arial", "", 12);
$pdf->Cell(90, 10, "Recibido por:", 0, 0, "C");
$pdf->Cell(90, 10, "Entregado por:", 0, 1, "C");
$pdf->Ln(20);
$pdf->Cell(90, 10, "________________________", 0, 0, "C");
$pdf->Cell(90, 10, "________________________", 0, 1, "C");

// =============================
// 4. Guardar archivo y registrar URL
// =============================
...
try {
    ...
    error_log("Error al registrar PDF URL: " . $e->getMessage());
}

// =============================
// 5. Mostrar PDF en navegador
// =============================
